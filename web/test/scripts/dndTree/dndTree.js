	// Get JSON data
	var action_param = location.search.split('action=')[1]
	var member_param = location.search.split('m=')[1]
	treeJSON = d3.json("scripts/actions.php?action=" + action_param + '&m=' + member_param, function(error, treeData) {
