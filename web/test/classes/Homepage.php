...
class Homepage {
	...
	public function build_get_segments_form() {
	    ...
	    $this->get_segments_form .= "      <select class=\"w3-input w3-margin-0\">\n";
	    // Get IFO.
	    ...
	    $this->get_segments_form .= "  <div class=\"w3-container w3-threequarter w3-padding-0\">\n";
	    $this->get_segments_form .= "      <input class=\"w3-input w3-half w3-margin-0\" id=\"gps_start_time\" name=\"gps_start_time\" value=\"\" min=\"0\" type=\"number\" placeholder=\"GPS start\" />\n";
	    $this->get_segments_form .= "<input class=\"w3-input w3-half w3-margin-0\" id=\"gps_start_time\" name=\"gps_start_time\" value=\"\" min=\"0\" type=\"number\" placeholder=\"GPS stop\" />\n";
	    $this->get_segments_form .= "  </div>\n";
	    $this->get_segments_form .= "</div>\n";
	    // Include history.
	    $this->get_segments_form .= "<div class=\"w3-container w3-padding w3-border-top\">\n";
	    ...
	    $this->get_segments_form .= "  <div class=\"w3-button w3-blue w3-hover-grey w3-center\"><i class=\"fas fa-save cursor\"></i> Get segments</div>\n";
